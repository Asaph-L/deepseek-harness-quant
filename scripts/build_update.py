...
_SAN_PATS = [
    (r"D:[\\/]+" + "劳威派" + "量化数据[\\/]+cache", "data/cache"),
    (r"D:[\\/]+" + "劳威派" + "量化数据", "data"),
    (r"C:[\\/]+Users[\\/]+" + "12985" + "[\\/]+Desktop[\\/]+" + "量化代码库思路库" + "[\\/]+因子池", "data/factorpool"),
    (r"C:[\\/]+Users[\\/]+" + "12985" + "[\\/]+Desktop[\\/]+" + "劳威派量化" + "[\\/]+deepseek-harness-quant", "."),
    (r"C:[\\/]+Users[\\/]+" + "12985", "<home>"),
    (r"129" + "85", "<home>"),
